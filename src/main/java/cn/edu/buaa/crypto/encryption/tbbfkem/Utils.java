package cn.edu.buaa.crypto.encryption.tbbfkem;
...
public class Utils {
    ...
    public static int calculateTargetBloomFilterTreeDepth(int filterSize) {
        return (int) Math.ceil(Utils.log2(filterSize));
    }

    public static int calculateTargetTimeBasedTreeDepth(int timeSlotsNumber) {
        return (int) Math.floor(Utils.log2(timeSlotsNumber));
    }

    public static int calculateNumberOfNodesOnLevel(int level) {
        return (int) Math.pow(2, level);
    }

    public static String getLeftChildNodeId(String parentNodeId) {
        return parentNodeId + "0";
    }

    public static String getRightChildNodeId(String parentNodeId) {
